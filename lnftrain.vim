...
map   \
nnoremap \size :resize 10
nnoremap \gs :vertical terminal ++open git status 
nnoremap \d :YcmCompleter GoTo 
nnoremap \dec :YcmCompleter GoToDeclaration
nnoremap \def :YcmCompleter GoToDefinition
map \print Oprint(colored("DEBUG/ {}".format(), 'cyan'))
map \b Opdb.set_trace() # BREAKPOINT 
nnoremap \f za
nnoremap \sp :sp  
nnoremap \v :vs 
map \l l
...
silent only
cd ~/Small_Obstacle_Segmentation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +119 train.py
badd +26 dataloaders/utils.py
badd +75 dataloaders/__init__.py
badd +0 utils/helpers.py
badd +15 mypath.py
badd +0 utils/saver.py
badd +0 utils/metrics.py
argglobal
silent! argdel *
$argadd train.py
set stal=2
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 71 - ((44 * winheight(0) + 22) / 45)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
71
normal! 0
tabedit utils/saver.py
set splitbelow splitright
wincmd t
set winminheight=1 winheight=1 winminwidth=1 winwidth=1
argglobal
